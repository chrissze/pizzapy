...
def calculate_target_prices(prices: List[float]) -> Tuple[Optional[float], Optional[float], Optional[float], Optional[float], Optional[float], float, float, float, float, Optional[float], Optional[float], Optional[float], Optional[float]]:
    """
    * INDEPENDENT *
    IMPORTS: conver_to_changes(), first(), grab(), quantile()
    USED BY: get_technical_values()

    # td's closing price will the the first element of prices argument, prices are placed from td to the past
    ...
    return price, p20, p50, p125, p200, increase_20, decrease_20, increase_50, decrease_50, best_20, worst_20, best_50, worst_50
...
def check_top_bottom(pairs: List[Tuple[date, float]], td_price: Optional[float], td: date) -> Tuple[Optional[bool],Optional[bool]]:
    ...
    * INDEPENDENT *
    ...
    """
    plus_50_prices = [price for (day, price) in pairs if td < day < add_trading_days(td, 51)]
...
def get_technical_values(pairs: List[Tuple[date, float]], td: date) -> Any:
    ...
    pairs argument is a dataset of extended dates, it is FROM-1000 till TO+50, pairs are generated by get_td_adjclose(), 
    ...
    td_price, p20, p50, p125, p200, increase_20, decrease_20, increase_50, decrease_50, best_20, worst_20, best_50, worst_50 = calculate_target_prices(td_prices)
