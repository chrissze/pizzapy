...
def get_zacks_estimates(symbol: str) -> Optional[str]:
    """

    """

    estimates_url: str = f'https://www.zacks.com/stocks/quote/{symbol}/detailed-estimates'
    print(estimates_url)
    estimates_dfs: List[DataFrame] = get_html_dataframes(estimates_url)
...
def test() -> None:
    ...
    result = get_zacks_estimates(symbol)
    print(result)
